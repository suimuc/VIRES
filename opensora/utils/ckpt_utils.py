...
def load_from_sharded_state_dict_1(model, ckpt_path, strict=False):
    ckpt_io = GeneralCheckpointIO()
    ckpt_io.load_model(model, ckpt_path, strict=strict)
...
def load_checkpoint(model, ckpt_path, save_as_pt=False, model_name="model", strict=False):
    ...
    if ckpt_path.endswith(".pt") or ckpt_path.endswith(".pth"):
        ...
        if os.path.isdir(model_dir):
            ...
            load_from_sharded_state_dict_1(model, ckpt_path, strict=strict)
