...
def parse_args(training=False):
    ...
    if not training:
        ...
        parser.add_argument("--sketch_video", default=None, type=str)
        parser.add_argument("--mask_video", default=None, type=str)
        ...
        parser.add_argument("--start_frame", action="store_true", help="Set to True if provided, otherwise False")
        
        parser.add_argument("--cfg_guidance_scale", default=None, type=float)
        parser.add_argument("--sampling_steps", default=None, type=int)
